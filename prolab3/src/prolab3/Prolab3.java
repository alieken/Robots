...
public class Prolab3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Engel almak icin 0'i Tuslayiniz");
        engeller1.EngelAl();
        // engeller1.robotyeri();
      ...
      window.setVisible(true);*/
        ...
        for (int i = 0; i < robotSayisi; i++) {
            ...
            if (RobotTipiT.equals("gezgin")) {
                ...
                if (c.equals("paletli")) {
                    ...
                    gecici.MotorSayisi = scan1.nextInt();
                    ...
                    System.out.println(g2.MotorSayisi);
                }
        ...
        for (int i = 0; i < robotSayisi; i++) {
            ...
            if (robotTipi.get(RobotSec - 1).equals("gezgin")) {
                ...
                System.out.println(Yuk.YukHizi);
